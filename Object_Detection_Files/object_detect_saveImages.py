...
if __name__ == "__main__":
    ...
    # Create a folder for saving the person images
    save_folder = "person_images"
    ...
    while True:
        ...
        # Save the image if a person is detected
        if person_detected:
            image_path = os.path.join(save_folder, f"person_{counter}.jpg")
